...
const Profile = (props)=>{
    ...
    const {_id,name,position,email,phone,picture} = props.route.params.item;
    console.log(_id)
    ...
    return(
        ...
        <View style={styles.root}>
            ...
            <View style={{alignItems:"center"}}>
                ...
                />
                {/* <IconButton 
                 style={{backgroundColor:"#008b8b", marginLeft:'32%',marginTop:-25}}
                 icon="border-color"
                 mode="contained"
                 onPress={() => props.navigation.navigate("imupdate",{picture})}
                 /> */}
